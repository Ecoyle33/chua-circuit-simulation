# ------Model of Lorenz attractor based off real values drawn from the Chua Circuit setup shown on chuacircuits.com---------
...
def chua(r, t):
    ...
    m1 = m12+m11
    #following if statements shape the curve - Needs to act like two NRCs alternating current towards one another
    if V1 > V2:
        m0 = m11 + m02
